...
public class ComprobanteComprasDAO extends GenericoDAO {
    ...
    public ComprobanteCompras getComprobanteByProveedorAndNumero(Proveedor p, String l, Integer s, Integer n, Boolean d, String tc) {
        ...
        Session session = HibernateUtils.getSessionFactory().getCurrentSession();
        c = (ComprobanteCompras) session.createCriteria(ComprobanteCompras.class)
    ...
    public ComprobanteCompras getComprobanteNcByProveedorAndNumero(Proveedor p, String l, Integer s, Integer n) {
        ComprobanteCompras c = null;
        Session session = HibernateUtils.getSessionFactory().getCurrentSession();
        c = (ComprobanteCompras) session.createCriteria(ComprobanteCompras.class)
                .add(Restrictions.eq("proveedor", p))
                ...
                .add(Restrictions.eq("tipoComprobante", "NC"))
                .uniqueResult();
        return c;
    }
    ...
    public List<ComprobanteCompras> getFacturasPendientesEntreFechas(Date fd, Date fa) {
        ...
        Session session = HibernateUtils.getSessionFactory().getCurrentSession();
        comprobantes = (List<ComprobanteCompras>) session.createCriteria(ComprobanteCompras.class)
    ...
    public List<ComprobanteCompras> getComprobantesParaVencimientos() {
        List<ComprobanteCompras> comprobantes = null;
        Session session = HibernateUtils.getSessionFactory().getCurrentSession();
        comprobantes = (List<ComprobanteCompras>) session.createCriteria(ComprobanteCompras.class)
                //                        .add(Restrictions.isNotNull("diasVencimiento"))
                //                        .add(Restrictions.eq("esDebito", true))
                //                        .addOrder(Order.asc("proveedor"))
                //                        .addOrder(Order.asc("fechaFactura"))
                //                        .addOrder(Order.asc("id"))
    ...
    public List<ComprobanteCompras> getFcPorProveedorImpagasPorVencimiento(Proveedor p) {
        List<ComprobanteCompras> comprobantes = null;
        Session session = HibernateUtils.getSessionFactory().getCurrentSession();
        comprobantes = (List<ComprobanteCompras>) session.createCriteria(ComprobanteCompras.class)
                .add(Restrictions.eq("proveedor", p))
                .add(Restrictions.eq("estaPago", false))
                .add(Restrictions.eq("esDebito", true))
                .addOrder(Order.asc("fechaCalculoVencimiento"))
                .addOrder(Order.asc("id"))
                .list();
        return comprobantes;
    }

    public List<ComprobanteCompras> getFacturasPrimerVencimiento(Proveedor p) {
        List<ComprobanteCompras> comprobantes = null;
        Session session = HibernateUtils.getSessionFactory().getCurrentSession();
        comprobantes = (List<ComprobanteCompras>) session.createCriteria(ComprobanteCompras.class)
                .add(Restrictions.eq("proveedor", p))
                .add(Restrictions.eq("estaPago", false))
                .add(Restrictions.eq("esDebito", true))
                .add(Restrictions.isNotNull("fechaCalculoVencimiento"))
                .addOrder(Order.asc("fechaCalculoVencimiento"))
                .addOrder(Order.asc("id"))
                .list();
        return comprobantes;
    ...
    public List<ComprobanteCompras> getFacturasPrimerVencimiento3(Proveedor p) {
        List<ComprobanteCompras> comprobantes = null;
        Session session = HibernateUtils.getSessionFactory().getCurrentSession();
        comprobantes = (List<ComprobanteCompras>) session.createCriteria(ComprobanteCompras.class)
                .add(Restrictions.eq("proveedor", p))
    ...
    public List<ComprobanteCompras> getAllNotPorProveedor(Proveedor p) {
        List<ComprobanteCompras> comprobantes = null;
        Session session = HibernateUtils.getSessionFactory().getCurrentSession();
        comprobantes = (List<ComprobanteCompras>) session.createCriteria(ComprobanteCompras.class)
                .add(Restrictions.eq("proveedor", p))

...
import ar.com.ventas.frame.ListarRecibosNuevaVersionFrame;
...
import ar.com.ventas.frame.importarExcelParaMarcarProductosPreciosGondolaFrame;
...
//        System.out.println(df_grv.format(100));
    ...
    private void initComponents() {
        ...
        buscarDomiciliosDuplicadosMnu = new javax.swing.JMenuItem();
        importarExcelParaMarcarProductosPreciosGondolaMnu = new javax.swing.JMenuItem();
        ...
        panelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelLayout.createSequentialGroup()
                .addGap(248, 306, Short.MAX_VALUE)
        ...
        buscarDomiciliosDuplicadosMnu.setText("BUSCAR DOMICILIOS DE CLIENTES DUPLICADOS");
        herramientas.add(buscarDomiciliosDuplicadosMnu);

        importarExcelParaMarcarProductosPreciosGondolaMnu.setText("IMPORTAR EXCEL PARA SELECCION GONDOLA");
        importarExcelParaMarcarProductosPreciosGondolaMnu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                importarExcelParaMarcarProductosPreciosGondolaMnuActionPerformed(evt);
            }
        });
        herramientas.add(importarExcelParaMarcarProductosPreciosGondolaMnu);
...
//        clientes = new ClienteService().getAllClientesActivos();
    ...
    private void importarExcelParaMarcarProductosPreciosGondolaMnuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importarExcelParaMarcarProductosPreciosGondolaMnuActionPerformed
        importarExcelParaMarcarProductosPreciosGondola();
    }//GEN-LAST:event_importarExcelParaMarcarProductosPreciosGondolaMnuActionPerformed
    ...
    private javax.swing.JMenuItem buscarDomiciliosDuplicadosMnu;
    ...
    private javax.swing.JMenuItem importarExcelParaMarcarProductosPreciosGondolaMnu;
    ...
    private void listarRecibos() {
        ListarRecibosNuevaVersionFrame lrf = new ListarRecibosNuevaVersionFrame();
        lrf.setVisible(true);
        this.dispose();
    }
...
//    }
    ...
    private void importarExcelParaMarcarProductosPreciosGondola() {
        JFileChooser selector = new JFileChooser();
        selector.showOpenDialog(this);
        File archivo = selector.getSelectedFile();
        if (archivo != null) {
            importarExcelParaMarcarProductosPreciosGondolaFrame ipf = new importarExcelParaMarcarProductosPreciosGondolaFrame(archivo);
            ipf.setVisible(true);
            this.dispose();
        }
    }
    ...
    private void limpiarCampos() {
        ...
        jFrame.setTitle("MENU PRINCIPAL - DIST.A&M");

...
public class ModificaComprobanteComprasFrame1 extends javax.swing.JFrame {
    ...
    private Integer row19 = 0;
    private Date df1 = new Date();
     ...
     * @param row19
     */
    public ModificaComprobanteComprasFrame1(ComprobanteCompras comprobante, Date df1, Date af, Integer row19) {
    ...
    private void initComponents() {
        ...
        setTitle("MODIFICAR IMPORTES EN COMPROBANTE COMPRAS");
...
//                              request focus mismo campo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificaComprobanteComprasFrame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificaComprobanteComprasFrame1(null, null, null, 0).setVisible(true);
            }
        });
    }
...
//            Long id = comprobante.getId();
            try {
                ...
                Logger.getLogger(ModificaComprobanteComprasFrame1.class.getName()).log(Level.SEVERE, null, ex);
...
//            JOptionPane.showMessageDialog(this, "Comprobante guardado correctamente");
    ...
    private void cargarConfiguracion() {
        impresionBtn.setVisible(false);
        comboPeriodos.setEnabled(false);
        fechaFacturaTxt.setEditable(false);
        facturaChk.setEnabled(false);
        notaCreditoChk.setEnabled(false);
...
//        int row = comboPeriodos.getSelectedIndex();
        Double t = Double.valueOf(totalTxt.getText().replace(",", "."));
        String to1 = df.format(t);
        String to2 = df.format(comprobante.getTotal());
        Long t2 = t.longValue();
        if (t2 == 0) {
        ...
        if (!to2.equals(to1)) {
            ...
            JOptionPane.showMessageDialog(this, "MODIFICO TOTAL DE FACTURA");
            return false;
        }
//        if (row < 1) {
...
//        JOptionPane.showMessageDialog(this, df1);
        AbmComprobantesCompraFrame av = new AbmComprobantesCompraFrame(df1, af, row19);
        av.setVisible(true);
        this.dispose();
    }

...
public class AbmProductoFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        agregaListaMnu = new javax.swing.JButton();
        quitaListaMnu = new javax.swing.JButton();
        ...
        tablaProductos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Codigo de barra", "Detalle", "Precio", "Impuesto", "Rubro", "Sub rubro", "Sugerido", "En Lista"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Object.class
            };
        ...
        exportarBtn.setText("Exportar Activos");
        ...
        agregaListaMnu.setText("Agrega a Lista Precios");
        agregaListaMnu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                agregaListaMnuActionPerformed(evt);
            }
        });

        quitaListaMnu.setText("Quita de Lista Precios");
        quitaListaMnu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                quitaListaMnuActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(agregaListaMnu)
                        .addGap(18, 18, 18)
                        .addComponent(quitaListaMnu)
    ...
    private void agregaListaMnuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregaListaMnuActionPerformed
        int row = tablaProductos.getSelectedRow();
        if (row < 0) {
            JOptionPane.showMessageDialog(this, "SELECCIONE PRODUCTO PARA ACTUALIZAR");
            return;
        }
        Producto pro = listadoProducto.get(row);
        agregar(pro);
    }//GEN-LAST:event_agregaListaMnuActionPerformed

    private void quitaListaMnuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_quitaListaMnuActionPerformed
        int row = tablaProductos.getSelectedRow();
        if (row < 0) {
            JOptionPane.showMessageDialog(this, "SELECCIONE PRODUCTO PARA ACTUALIZAR");
            return;
        ...
        Producto pro = listadoProducto.get(row);
        quitar(pro);
    }//GEN-LAST:event_quitaListaMnuActionPerformed
    ...
    private javax.swing.JButton agregaListaMnu;
    ...
    private javax.swing.JButton quitaListaMnu;
    ...
    private void llenarTabla() {
        ...
        if (listadoProducto != null && !listadoProducto.isEmpty()) {
            for (Producto producto : listadoProducto) { // Recorro la lista de productos y lleno la tabla.
                ...
                fila[5] = producto.getRubro().getNombre();
                fila[6] = producto.getSubRubro().getDetalle();
                fila[7] = df.format(producto.getSugerido());
                if (producto.getListaPdf() != null) {
                    if (producto.getListaPdf()) {
                        fila[8] = "LISTA";
                    } else {
                        fila[8] = "NO";
                    }
...
//        return false;
    ...
    private void agregar(Producto pro) {
        String prod = pro.getDetalle();
        int a = JOptionPane.showConfirmDialog(this, "CONFIRME AGREGAR A LISTA DE PRECIOS A:/n"
                + prod, "Atención", JOptionPane.YES_NO_OPTION);
        if (a == 0) {
            pro.setListaPdf(true);
            try {
    ...
    private void quitar(Producto pro) {
        String prod = pro.getDetalle();
        int a = JOptionPane.showConfirmDialog(this, "CONFIRME QUITAR DE LA LISTA DE PRECIOS A:/n"
                + prod, "Atención", JOptionPane.YES_NO_OPTION);
        if (a == 0) {
            pro.setListaPdf(false);
            try {
                new ProductoService().updateProducto(pro);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "ERROR ACTUALIZANDO PRODUCTO");

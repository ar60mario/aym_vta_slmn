 ...
 */
public class ModificaPeriodoComprobanteComprasFrame extends javax.swing.JFrame {
     ...
     * @param row
     */
    public ModificaPeriodoComprobanteComprasFrame(ComprobanteCompras comprobante, Date df, Date af, Integer row) {
...
//                              request focus mismo campo
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificaPeriodoComprobanteComprasFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificaPeriodoComprobanteComprasFrame(null, null, null, 0).setVisible(true);
            }
        });
    }
    ...
    private void guardar() {
        if (validar()) {
            ...
            try {
                ...
                Logger.getLogger(ModificaPeriodoComprobanteComprasFrame.class.getName()).log(Level.SEVERE, null, ex);
...
//            }
    ...
    private void llenarCampos() {
        ...
        prontoPagoChk.setEnabled(false);

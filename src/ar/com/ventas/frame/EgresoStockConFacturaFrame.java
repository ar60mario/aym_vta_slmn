 ...
 * @author Mario
 */
public class EgresoStockConFacturaFrame extends javax.swing.JFrame {
    ...
    private List<ProductoStock> stock = new ArrayList<ProductoStock>();
     ...
     * @param xNom
     */
    public EgresoStockConFacturaFrame(Usuario u, String fil, Boolean xNom) {
        initComponents();
        this.usuario = u;
        this.fil = fil;
        this.xNom = xNom;
...
//        limpiarCampos();
    ...
    private void leerCantidadBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_leerCantidadBtnActionPerformed
        ...
        nuevaCantidadTxt.setText(df.format(p.getCantidad() * -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EgresoStockConFacturaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EgresoStockConFacturaFrame(null, null, null).setVisible(true);
            }
        });
    }
    ...
    private void ingresar() {
        if (!stock.isEmpty()) {
            int op = JOptionPane.showConfirmDialog(null, "Confirma egresar Stock?",
                    "ACTUALIZAR STOCK",
            ...
            if (op == 0) {
                ...
                try {
                    ...
                    Logger.getLogger(EgresoStockConFacturaFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
                long nf = 0L;
                if (con != null) {
    ...
    private void volver() {
        AbmStockFrame mf = new AbmStockFrame(usuario, fil, xNom);
        mf.setVisible(true);
        this.dispose();
    }
    ...
    private void ingresar0() {
        ...
        Float ca = Float.valueOf(cantidadTxt.getText()) * -1;
        ps.setCantidad(ca);
        ps.setStock(producto.getStock());
        if (producto.getStock() != null) {
            ps.setTotal(ca + producto.getStock());
        } else {
            ps.setTotal(ca);
        }

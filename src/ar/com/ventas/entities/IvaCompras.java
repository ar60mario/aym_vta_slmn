...
public class IvaCompras {
    ...
    public IvaCompras(Long id, Date fechaPeriodo, Date fechaFactura, Proveedor proveedor, String letra, Integer numeroSucursal, Integer numeroFactura, Double gravado, Double noGravado, Double impuestoInterno, Double percepcionIiBb, Double percepcionIva, Double otro, Double iva, Double total, Boolean credito, ComprobanteCompras comprobante) {
        this.id = id;
